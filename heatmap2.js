...
/*var margin = {top: 20, right: 25, bottom: 30, left: 140};*/
  let width=+d3.select("#my_dataviz").style("width").slice(0,-2);
let height=+d3.select("#my_dataviz").style("height").slice(0,-2); 
 let pad=width/8;
...
d3.csv(`https://raw.githubusercontent.com/JBreitenbr/Bulma-Navbar/refs/heads/main/Data/${period.split(" ")[1]}/${period.split(" ")[0]}/heatmap.csv`, function(data) {
  ...
  let blues=["#ffffff","#deebf7","#c6dbef",
"#9ecae1","#6baed6","#4292c6","#2171b3","#08519c","#08306b", "#000080"];
function colored(n){
  return blues[n];
}
